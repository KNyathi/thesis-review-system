...
export async function generateReviewPDF(
  ...
  // Preserving the grade functionality
  ...
  // Signature functionality - preserving the three signatures with IReviewer
  const drawSignatureBlocks = async (
    ...
    return currentY - 3 * signatureConfig.blockHeight - 20;
  };
  ...
  const fileName = `unsigned_review2_${thesis.student}.pdf`;
