...
const StudentDashboard = () => {
  ...
  const fetchThesis = useCallback(
    async (forceRefresh = false) => {
      try {
        ...
        if (
          forceRefresh ||
          !lastUserUpdateRef.current ||
          Date.now() - lastUserUpdateRef.current > 30000
        ) {
          // 30 seconds
          await refreshUser();
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-4xl mx-auto">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 text-gray-400">
                    ...
                    <span className="text-sm">
                      Title set in profile - ready for file upload
                    </span>
                  </div>
                </div>
                <button
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      You have set your thesis title. Now upload your thesis
                      file to complete the submission.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {thesis && !showReupload ? (
            ...
            <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
              ...
              {thesis.finalGrade && thesis.status === "evaluated" && (
      ...
      <Modal
        isOpen={showThesisDetails}
        onClose={() => setShowThesisDetails(false)}
